package kaba4cow.renderEngine.renderers.menu;
...
import kaba4cow.renderEngine.shaders.menu.DynamicFrameShader;
...
public class DynamicFrameRenderer extends AbstractRenderer {

	private List<Renderable> map = new ArrayList<Renderable>();

	public DynamicFrameRenderer(Renderer renderer) {
		super(renderer, DynamicFrameShader.get());
	}
	...
	@Override
	public DynamicFrameShader getShader() {
		return (DynamicFrameShader) shader;
	}
